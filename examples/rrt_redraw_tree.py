...
print('globby',f'{args.episode_id}_*.json')
json_path = glob.glob(os.path.join(args.json_dir, f'{args.episode_id}_*.json'))[0]
...
rrt_unicycle._load_tree_from_json(
    json_path = json_path
)

rrt_unicycle._visualize_tree(
    meters_per_pixel=0.025,
    show=True,
    save_path=f'/Users/naoki/Downloads/{args.episode_id}.png'
)